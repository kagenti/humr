...
- [Agent lifecycle](agent-lifecycle.md) — create → wake → trigger → hibernate → delete
- [Persistence](persistence.md) — spec/status split, DB-backed sessions, PVC lifecycle
- [Security and credentials](security-and-credentials.md) — OneCLI, Keycloak, NetworkPolicies
