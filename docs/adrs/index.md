...
| [005](005-credential-gateway.md) | Gateway pattern for credentials — agent never sees tokens | @tomkis |
...
| [010](010-onecli-deployment.md) | OneCLI deployment — single image, two Services | @tomkis |
