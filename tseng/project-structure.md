...
<!-- package: api-server-api | role: contract | path: packages/api-server-api | package_name: api-server-api -->
...
<!-- package: code-guardian | role: other | path: packages/code-guardian | package_name: code-guardian -->
