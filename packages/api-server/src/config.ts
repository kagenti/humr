...
const configSchema = z.object({
  ...
  unifiedChannelEnabled: z.coerce.boolean().default(false),
  channelOauthCallbackUrl: z.string().nullable().default(null),
...
export function loadConfig(): Config {
  return configSchema.parse({
    ...
    unifiedChannelEnabled: process.env.UNIFIED_CHANNEL_ENABLED,
    channelOauthCallbackUrl: process.env.CHANNEL_OAUTH_CALLBACK_URL,
